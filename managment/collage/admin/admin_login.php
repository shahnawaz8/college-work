...
<head>
	<meta charset="UTF-8">
	<title>Login SIET Collage</title>
...
<!---------------------------header and fix sidebar-------------------------->
	...
	<div class="header">
		<div class="coverhead">
			<a href="../index.html" id="logo"><img src="../images/SIET-LOGO.jpg" alt="logo" height="58" width="381"></a>
			<div class="coverul">
				<div id="topbar"> 
  				   <ul>
  				 	<li><a href="#">LUCKY<sup><i class="fa fa-trademark fa-fw "></i></sup></a></li>
	...
	<div class="sidebar">	
				...
				<ul>
					...
					<li ><a href="../managment/managmentpanel.php"><i class="fa fa-ellipsis-v fa-fw "></i>Staff Data Base</a></li>
...
<div class="footer">
	...
	<div class="foot4">
		...
		<div class="f42">
			<br>
			<i class="fa fa-envelope fa-fw"></i>mohdshahnawaz846@gmail.com<br><br>
			<i class="fa fa-phone fa-fw"></i>+91-865-009-0359
