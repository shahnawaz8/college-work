...
if(isset($_POST['update']))
{
 ...
 $sql = "SELECT paidfee FROM mcom  WHERE sid=$edit  ";
$run = mysql_query($sql);
...
//now upload it to database
	...
	$query1 = "UPDATE mcom SET paidfee='$result'	WHERE sid=$edit ";
...
<head>
	<meta charset="UTF-8">
	<title>M.Com Fee Managment SFK Collage</title>
...
<div class="marginl" >
		...
		<div class="sidemenu fleft">
			<ul>
				...
				<li  id ="selectedli"><a href="mcomfeeview.php"><i class="fa fa-graduation-cap fa-fw"></i> M.com Class Fee</a>	</li>
