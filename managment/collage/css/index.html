...
<body>
	<div class="header">
		<div class="coverhead">
			<a href="../pages/index.html" id="logo"><img src="../images/logo.png" alt="logo" height="58" width="400"></a>
			<div class="coverul">
				<div id="topbar"> 
  				   <ul>
	...
	<div class="sidebar">	
		...
		<marquee id="marquee" onmouseover="this.stop();" onmouseout="this.start();"> SFK any news any flash back here </marquee>
				...
				<div>
					...
					<h1>Some Features..</h1>
						<div>	
							...
							<i class="fa fa-bus fa-fw"></i>School Buses........<br>
							<i class="fa fa-bus fa-fw"></i>School Buses........<br>
						</div>
