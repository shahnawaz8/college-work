...
$query = "SELECT * FROM dcom WHERE id='$edit_record'";
		...
		<div class="admincontent fleft">
			<div>
					...
					<div class="fleft insert sphover">
								 <a href="dcomdsform.php"><i class="fa fa-plus-circle fa-fw"></i> Insert New Subject</a>
					</div>
					<div class="fleft insert sphover">
			...
			<div class="studentlist">
					...
					<div class='insert sphover center'>
						Update Dcom Date Sheet Subject 
					</div>
			<table>
			<form method="post" action="dcomdsedited.php?edited_form=<?php echo $id;?>">
...
if(isset($_POST['submit']))
{
	...
	$query1 = "UPDATE dcom SET subjects='$subjects',
								place='$place',
								date='$date',
								time='$time'
	...
	{
		echo "<script>window.open('dcomdsview.php?updated=Record Updated','_self')</script>";}
