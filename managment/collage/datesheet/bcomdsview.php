...
<head>
	<meta charset="UTF-8">
	<title>B.Com Date Sheet SFK Collage</title>
		...
		<div class="admincontent fleft">
			<div>
					...
					<div class="fleft insert sphover">
								 <a href="dcomdsform.php"><i class="fa fa-plus-circle fa-fw"></i> Insert New Record</a>
					</div>
...
if ($result->num_rows > 0) {
     ...
     while($row = $result->fetch_assoc()) {	$del=$row["id"]; $edit=$row["id"];
         ...
         echo " <div class='detaillist'>
								...
								<ul >
									...
									<li>
										<a href='bcomdsedited.php?edit=$edit'><i class='fa fa-edit fa-lg fa-fw'></i></a>
										<a href='bcomdsdelete.php?del=$del'><i class='fa fa-remove fa-lg fa-fw'></i></a>
