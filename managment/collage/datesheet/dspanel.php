...
<div class="marginl" >
		<div class="maintext"><hr>
			Welecome <?php echo $_SESSION['user_name'];?> to Date Sheet Panel<hr>
		</div>


		<div class="sidemenu fleft">
			<ul>
				<li id ="selectedli"><a href="dspanel.php"><i class="fa fa-user-circle fa-fw"></i>Date Sheet Panel</a>    </li>
