...
$query = "SELECT * FROM bcomt WHERE tid='$edit_record'";
...
<head>
	<meta charset="UTF-8">
	<title>B.Com Class SFK Collage</title>
...
<div class="marginl" >
		...
		<div class="sidemenu fleft">
			<ul>
				...
				<li   ><a href="dcomtview.php"><i class="fa fa-pencil fa-fw "></i> D.com Class</a>    </li>	
				<li id ="selectedli"><a href="bcomtview.php"><i class="fa fa-book fa-fw"></i> B.com Class</a>    </li>
		...
		<div class="admincontent fleft">
			<div>
					...
					<div class="fleft insert sphover">
								 <a href="bcomtview.php"><i class="fa fa-database fa-fw"></i> B.com All Database</a>
					</div>
			...
			<div class="studentlist">
					...
					<div class='insert sphover center'>
						Bcom Teacher Data Update
					</div>
			<table>
			<form method="post" action="bcomtedited.php?edited_form=<?php echo $tid;?>" enctype="multipart/form-data">
			...
			<tr><th>Class teacher</th><td><input type="text" name="class"  disabled value="B.Com" /></td>
...
if(isset($_POST['submit']))
{
	...
	$query1 = "UPDATE bcomt SET reg_no='$roll_no1',
	...
	{
		echo "<script>window.open('bcomtview.php?updated=Record Updated','_self')</script>";}
