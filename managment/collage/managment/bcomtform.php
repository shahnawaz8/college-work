...
<div class="marginl" >
		...
		<div class="admincontent fleft">
			<div>
					...
					<div class="fleft insert sphover">
								 <a href="bcomtview.php"><i class="fa fa-database fa-fw"></i> D.com Teacher Database</a>
					</div>
...
?>
					...
					<div class='insert sphover center'>
						Bcom New Teacher Registration
					</div>
			<table>
			<form method="post" action="bcomtform.php" enctype="multipart/form-data">
