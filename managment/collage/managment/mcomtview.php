...
<head>
	<meta charset="UTF-8">
	<title>M COM Class Database SFK Collage</title>
...
<div class="marginl" >
		...
		<div class="sidemenu fleft">
			<ul>
				<li><a href="managmentpanel.php"><i class="fa fa-user-circle fa-fw"></i>Admin Panel</a>    </li>
				...
				<li  id ="selectedli"><a href="mcomtview.php"><i class="fa fa-graduation-cap fa-fw"></i> M.com Teachers</a>	</li>
     ...
     while($row = $result->fetch_assoc()) {	$del=$row["tid"]; $edit=$row["tid"];$det=$row["tid"];
         ...
         echo " <div class='detaillist'>
								...
								<ul >
									...
									<li>
										<a href='mcomtedited.php?edit=$edit'><i class='fa fa-edit fa-lg fa-fw'></i></a>
										<a href='mcomtdelete.php?del=$del'><i class='fa fa-remove fa-lg fa-fw'></i></a>
										<a href='mcomtdetail.php?detail=$det'><i class='fa fa-info-circle fa-lg fa-fw'></i></a>
									</li>
								</ul>
