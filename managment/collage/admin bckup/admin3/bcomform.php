...
<head>
	<meta charset="UTF-8">
	<title>B.com Student Registration SFK Collage</title>
...
<!---------------------------header and fix sidebar-------------------------->
	...
	<div class="sidebar">	
				...
				<ul class="sideul">
					...
					<li><a href="bcomview.php"><i class="fa fa-ellipsis-v fa-fw "></i>B.COM Class</a></li>
...
$sqlDate = date('Y-m-d H:i:s'); 
		...
		$insert = "INSERT INTO $Table (roll_no,Student_Name, Father_Name, CNIC, Birth_Date,
										  ...
										  inter_board,inter_percentage,inter_year,Registration_Date ) 
					  VALUES('$_POST[rollno]','$_POST[sname]', '$_POST[fname]', '$_POST[nic]', '$_POST[dob]'
							...
							, '$_POST[inter_board]','$_POST[inter_percentage]','$_POST[inter_year]','$sqlDate')";		
...
<br>
<div class="frm">
<form action="bcomform.php" method="POST">
...
<input type="text" name="inter_board" placeholder="Board Name" maxlength="30" required /><br><br>
