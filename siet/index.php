...
if(isset($_POST['login']))
{
	...
	{
		if($user_res['user_email']==$user_email and $user_res['user_pass']==$user_pass )
		{
			$_SESSION['semail']=$user_res['user_email']=$user_email;
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">SIET Mail Box</h1>
                  </div>
