...
<body>
    ...
    <div id="div1">
        ...
        <div class="menu"> <a href="login.php" id="a2" ><span class="fa fa-power-off fa-fw"></span>Logout</a></div>
    </div>
    <div id="div2">
        
        
        
    <div id="div2-1">    <marquee><b>Welcome to my <i>Webpage</i></b></marquee></div>
    <div id="div2-2"> <img src="new22.jpg" height="150px" width="110px"><br><a href="#" id="p">MOHD SHAHNAWAZ</a> </div>
